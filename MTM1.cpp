...
void checker(){ //code for the user
	...
	cin.getline(uname,19); //this will get every character with an specific size
...
void deposit(){ //code for deposit
	...
	cin>>depo;
	cout<<endl<<endl<<"P"<<"Deposit Money"<<endl;
...
void transfer(){ //code for transfering money
	...
	prof.Balance-=trans;
	cout<<"New Balance: "<<"P"<<prof.Balance<<endl;
	cout<<"P"<<trans<<" Successfully transferred to: "<<text;
}
else
{
	system("cls"); //this erase the previous output
